...
export default function ClientesPage() {
  const clientTypes = [
    {
      icon: Landmark,
      title: "Instituições e Proprietários de Ativos",
      description:
        "Empresas, instituições financeiras e proprietários que necessitam de gestão, administração, regularização e valorização de seus ativos imobiliários, com segurança jurídica, governança e eficiência operacional.",
    },
    {
      icon: Wallet,
  ...
  const benefits = [
    ...
    "Suporte técnico, jurídico e operacional em todas as etapas",
    "Rede nacional para atuação e acompanhamento regional",
    "Relatórios periódicos de desempenho, gestão e compliance",
    "Programa contínuo de integração e capacitação de parceiros",
  ];

  const testimonials = [
    {
      quote:
        "É genuíno o apoio, a atenção e o nível de comprometimento do Grupo Awake Brasil. Com profissionais engajados e competentes, os desafios são superados com maestria e as entregas com acabativa impecável.",
      author: "André Alvarenga",
      role: "Gerente de Facilities, Banco Sofisa S.A.",
    },
    {
      quote:
        "A assessoria de ponta do Grupo Awake Brasil permitiu que concluíssemos negócios com êxito absoluto. Pelo excelente atendimento, recomendo.",
      author: "Dr. Oliveira",
        ...
        <div className="relative z-10 container mx-auto px-4">
          <motion.div {...fadeInUp} className="max-w-4xl mx-auto space-y-6">
            ...
            <p className="text-xl text-slate-300 text-pretty leading-relaxed font-medium max-w-3xl mx-auto">
              Construímos alianças duradouras pautadas por excelência,
        ...
        <div className="container mx-auto px-4 max-w-4xl text-center">
          ...
          >
            ...
            <p className="text-lg text-slate-600 leading-relaxed">
              O Grupo Awake Brasil entende que o sucesso na gestão de ativos
              imobiliários não depende apenas da identificação de oportunidades,
              mas da construção de um ecossistema colaborativo. Nossos clientes
              e parceiros são parte integrante desse sucesso, materializando
              resultados relevantes no mercado nacional.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-lg text-slate-600">
                Ao se associar ao Grupo Awake Brasil, você passa a contar com
                uma estrutura completa de gestão e administração de ativos
                imobiliários, com governança, segurança e eficiência
                operacional.
              </p>

              <p className="text-lg text-slate-600">
                Nossa parceria é aberta a profissionais e colaboradores de
                diferentes áreas que desejam contribuir, somar expertise e
                participar de oportunidades estruturadas.
              </p>
            ...
            >
              <div className="relative z-10">
                ...
                <h3 className="text-2xl font-bold mb-4">
                  Rede de Agentes Credenciados
                </h3>
                <p className="text-slate-300 leading-relaxed mb-8">
                  Nossa rede compreende agentes, escritórios regionais e
                  parceiros estratégicos que atuam em colaboração, garantindo a
                  identificação de oportunidades onde há menos visibilidade.
                </p>
                <Button
                  variant="outline"
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <motion.div {...fadeInUp} className="space-y-8">
            ...
            <p className="text-lg sm:text-xl text-slate-600 max-w-2xl mx-auto font-medium">
              Nossa rede reúne profissionais, escritórios regionais e parceiros
              estratégicos de diferentes áreas de atuação, que colaboram para
              identificar oportunidades, apoiar processos e fortalecer a
              presença do Grupo Awake em todo o território nacional.
            </p>
