  ...
  const departments = [
    {
      ...
      description:
        "Responsável pela triagem e avaliação técnica, financeira e estratégica dos ativos imobiliários, assegurando decisões seguras, eficientes e orientadas à valorização patrimonial.",
      icon: Search,
    },
    {
      title: "Equipe de Campo",
      description:
        "Realiza vistorias in loco para validação de ocupação, localização, estado físico, documentação operacional e potencial de valorização do imóvel.",
      icon: MapPin,
    },
    {
      title: "Comercial e Relacionamento",
      description:
        "Estrutura o portfólio, conduz negociações e mantém o relacionamento com investidores e parceiros, garantindo alinhamento e transparência em todas as etapas.",
      icon: TrendingUp,
    },
    {
      title: "Departamento Jurídico",
      description:
        "Atua na análise jurídica e documental dos ativos, assegurando conformidade, segurança nas operações e suporte completo nos processos de regularização.",
      icon: Scale,
    },
  ];
  ...
  const methodology = [
    {
      ...
      description:
        "Análise técnica, jurídica, documental e operacional dos ativos já pertencentes à carteira do cliente, identificando riscos, pendências e oportunidades de organização patrimonial.",
    },
    {
      number: "02",
      title: "Due Diligence Documental e Jurídica",
      description:
        "Verificação completa da situação legal, registral, fiscal e ocupacional dos imóveis, assegurando conformidade normativa e mitigação de riscos jurídicos e operacionais.",
    },
    {
      number: "03",
      title: "Estruturação e Regularização",
      description:
        "Condução dos processos de regularização documental, adequação cadastral e organizaçãojurídica necessários para plena segurança e viabilidade administrativa do ativo.",
    },
    {
      number: "04",
      title: "Gestão e Valorização Patrimonial",
      description:
        "Administração estratégica dos imóveis com controle financeiro, manutenção,acompanhamento operacional e implementação de ações voltadas à preservação e valorização do patrimônio.",
    },
    {
      number: "05",
      title: "Monitoramento, Governança e Relatórios",
      description:
        "Acompanhamento contínuo da performance dos ativos, com relatórios periódicos, transparência de informações, compliance e suporte estratégico ao longo de todo o ciclo de gestão.",
    },
  ];
        ...
        <div className="relative z-10 container mx-auto px-4">
          <motion.div {...fadeInUp} className="max-w-5xl mx-auto space-y-6">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-white tracking-tight leading-tight">
              Excelência estratégica em gestão de ativos imobiliários
            </h1>
            <p className="text-xl text-slate-300 text-pretty leading-relaxed font-medium max-w-3xl mx-auto">
              Desde 2010, o Grupo Awake Brasil atua com solidez e visão para
              estruturar, administrar e valorizar ativos imobiliários,
              transformando patrimônio em oportunidades rentáveis com segurança,
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-slate-900 leading-tight">
                Da Estruturação à Gestão Patrimonial Completa
              </h2>

              <div className="space-y-6 text-slate-600 text-lg leading-relaxed">
                <p>
                  Desde sua constituição em 2010, o Grupo Awake Brasil vem se
                  consolidando como referência em gestão estratégica de ativos
                  imobiliários, atuando com solidez, organização e visão de
                  longo prazo para valorização patrimonial.
                </p>
                <p>
                  Ao longo dessa trajetória, a empresa expandiu sua atuação da
                  estruturação inicial dos ativos para um modelo completo que
                  integra regularização, organização documental, gestão
                  operacional, controle financeiro e administração patrimonial,
                  garantindo segurança, eficiência e geração de valor contínuo
                  para investidores e instituições.
                </p>
                <div className="pl-6 border-l-4 border-cyan-500 bg-slate-50 p-4 rounded-r-lg">
                  <p className="font-medium text-slate-800">
                    Com sede em Florianópolis (SC) e filial em São Paulo (SP), o Grupo Awake Brasil conta com presença
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h3 className="text-2xl font-bold text-white">
              Resultados que atestam nossa solidez
            </h3>
          </div>
          <div className="grid md:grid-cols-3 gap-12 text-center divide-y md:divide-y-0 md:divide-x divide-slate-700">
            {stats.map((stat, index) => (
              ...
              >
                <p className="text-5xl md:text-6xl font-bold text-cyan-400 mb-2">
                  {stat.value}
                </p>
                <p className="text-slate-300 uppercase tracking-widest text-sm font-semibold">
                  {stat.label}
                </p>
              </motion.div>
            ))}
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16 max-w-3xl mx-auto">
            ...
            <p className="text-lg text-slate-600">
              Operamos com áreas estruturadas para garantir controle, eficiência
              e excelência na gestão e administração de ativos imobiliários.
            </p>
          </div>
      ...
      <section className="py-24 bg-slate-50 border-y border-slate-200">
        <div className="container mx-auto px-4">
          <div className="text-center mb-20 max-w-3xl mx-auto">
            ...
            <p className="text-lg text-slate-600">
              Nossa abordagem estratégica divide-se em etapas fundamentais para
              garantir assertividade.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 mb-20 pb-16 border-b border-slate-800">
            ...
            >
              ...
              <div>
                ...
                <p className="text-slate-400 leading-relaxed text-lg">
                  Oferecer soluções completas e seguras em gestão e
                  administração de ativos imobiliários, garantindo governança,
                  transparência, eficiência operacional e valorização
            ...
            >
              ...
              <div>
                ...
                <p className="text-slate-400 leading-relaxed text-lg">
                  Ser reconhecida nacionalmente como referência em
                  credibilidade, eficiência e excelência na gestão e
                  administração de ativos imobiliários, entregando segurança e
                  performance patrimonial em cada operação.
                </p>
              </div>
            </motion.div>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6">
              {values.map((val, index) => (
                <div
                  key={index}
                  className="flex items-start gap-3 bg-slate-900/50 p-4 rounded border border-slate-800"
                >
        ...
        <div className="container mx-auto px-4 max-w-4xl">
          <motion.div {...fadeInUp} className="space-y-8">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-slate-900">
              Quer entender como podemos gerir e valorizar seus ativos
              imobiliários?
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center pt-6 flex-wrap">
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-slate-300 text-slate-700 hover:bg-slate-50 font-bold h-14 px-8 rounded-none"
                asChild
              >
